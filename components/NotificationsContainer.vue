...
.notification {
  ...
  &--success { border-left-color: $success; .notification-icon { color: $success; } }
  &--error   { border-left-color: $error-color; .notification-icon { color: $error-color; } }
  &--warning { border-left-color: $warning; .notification-icon { color: $warning; } }
  &--info    { border-left-color: $info; .notification-icon { color: $info; } }
}
...
// Strip TButton default sizing for the icon-only close button
.notification-close {
  flex-shrink: 0;
  padding: 0.125rem;
  min-height: auto;
